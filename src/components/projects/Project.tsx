          ...
          <Reveal width="w-full">
            <div className="flex items-center gap-2 w-full">
              ...
              <Link href={code} target="_blank" rel="nofollow">
                <AiFillGithub className="text-xl text-muted hover:text-primary transition-colors" />
              </Link>

              <Link href={projectLink} target="_blank" rel="nofollow">
                <AiOutlineExport className="text-xl text-muted hover:text-primary transition-colors" />
              </Link>
            </div>
          </Reveal>
          <Reveal>
